...
| AI governance: EU AI Act, NYC AEDT rules, Colorado ADMT Act (replaced the Colorado AI Act; effective 2027-01-01), similar laws | Conditional / likely if AI affects people decisions | HR, worker management, education, and vocational training AI can become high-risk. | Proposal-only AI and impact-assessment packet exist; external review missing |
