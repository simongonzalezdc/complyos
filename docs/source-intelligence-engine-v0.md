...
- **Implemented now:** deterministic source models, content-hash snapshots,
  ...
  receipts, notification outbox events, review UI, export packet, CLI commands,
  API endpoints, and focused tests.
...
- notification event/delivery receipt when a scheduled run enqueues hooks.
