...
| WP16a–d | **Authenticated enterprise web shell** — signed-session auth wrapping the existing `ActorContext`; 10 modules (Overview/Gaps/Imports/Records/Evidence/Remediation/Source-intel/Privacy/Readiness/Admin) on LIVE service data; import decide/promote wired; WCAG 2.2 AA accessibility + contrast audit enforced by tests | P6 |
